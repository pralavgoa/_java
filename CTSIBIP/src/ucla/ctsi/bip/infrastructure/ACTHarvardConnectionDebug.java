...
public class ACTHarvardConnectionDebug {

    public static String UCLA = "https://164.67.204.73:6443/actshrine/";
    public static String UCSF = "https://ucrex-proxy-01.ucsf.edu:8443/actshrine/";
    ...
    public static void test1() throws MalformedURLException, IOException {
        ...
        ((javax.net.ssl.HttpsURLConnection) new java.net.URL(UCLA).openConnection()).getInputStream();
