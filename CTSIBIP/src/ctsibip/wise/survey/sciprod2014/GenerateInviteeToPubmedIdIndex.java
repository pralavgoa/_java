...
public class GenerateInviteeToPubmedIdIndex {
    ...
    private static ResultSet getPublicationsForLastnameFirstInitial(String lastname, char firstInitial, Connection conn)
            throws SQLException {
        String sql = "SELECT * FROM sciprod2014.author_pubmedId,publications where author LIKE '"
                + lastname.replaceAll("'", "\\\\'") + " " + firstInitial + "%' AND pubmedId=pubmed_id";
