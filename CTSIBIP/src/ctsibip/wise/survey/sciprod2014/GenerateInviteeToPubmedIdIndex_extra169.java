...
public class GenerateInviteeToPubmedIdIndex_extra169 {
    ...
    private static ResultSet getPublicationsForLastnameFirstInitial(String lastname, char firstInitial, Connection conn)
            throws SQLException {
        String sql = "SELECT * FROM sciprod2014.author_pubmedId_extra,publications_extra where author LIKE '"
                + lastname.replaceAll("'", "\\\\'") + " " + firstInitial
                + "%' AND author_pubmedId_extra.pubmedId=publications_extra.pubmedId";
